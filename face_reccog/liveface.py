...
sneha_image = face_recognition.load_image_file("sneha.jpeg")
sneha_face_encoding = face_recognition.face_encodings(sneha_image)[0]

suri_image = face_recognition.load_image_file("suri.jpeg")
suri_face_encoding = face_recognition.face_encodings(suri_image)[0]
